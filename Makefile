...
# Template: vcapp
# Command: C:\Qt\5.3\mingw482_32\bin\qmake.exe -spec win32-g++ -tp vc CONFIG+=windeployqt -o Makefile QMLGalaxyPortal.pro
#############################################################################
...
Makefile: QMLGalaxyPortal.pro C:/Qt/5.3/mingw482_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.3/mingw482_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ -tp vc CONFIG+=windeployqt -o Makefile QMLGalaxyPortal.pro
