#############################################################################
# Makefile for building: QMLGalaxyPortal
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  QMLGalaxyPortal.pro
# Template: vcapp
# Command: C:\Qt\5.3\mingw482_32\bin\qmake -tp vc CONFIG+=windeployqt -o Makefile QMLGalaxyPortal.pro
#############################################################################
...
QMAKE         = C:\Qt\5.3\mingw482_32\bin\qmake
DEL_FILE      = del
...
Makefile: QMLGalaxyPortal.pro C:/Qt/5.3/mingw482_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.3/mingw482_32/mkspecs/features/spec_pre.prf \
		...
		C:/Qt/5.3/mingw482_32/mkspecs/features/win32/windeployqt.prf \
	...
	$(QMAKE) -tp vc CONFIG+=windeployqt -o Makefile QMLGalaxyPortal.pro
...
release-windeployqt:
	$(MAKE) -f $(MAKEFILE).Release windeployqt
debug-windeployqt:
	$(MAKE) -f $(MAKEFILE).Debug windeployqt
windeployqt: release-windeployqt debug-windeployqt
